...
return (
<div style={{ width: w, height: h, borderRadius: r, background: `linear-gradient(90deg,${C.layer2},${C.layer3},${C.layer2})`, backgroundSize: “200% 100%”, animation: “shimmer 1.4s ease-in-out infinite” }} />
);
}
