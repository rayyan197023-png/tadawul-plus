...
export var STRATEGY_DEFAULTS = {
  ...
  buyScoreThreshold: 72,       // اختبار: انتقائية أعلى لرفع معدل الفوز
  ...
  stopLossPct: -0.10,          // وقف أوسع -- يتحمّل الضجيج
  takeProfitPct: 0.28,         // هدف أبعد -- الحركة تغطّي التكلفة (نسبة 2.8:1)
