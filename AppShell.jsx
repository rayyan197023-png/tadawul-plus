...
function Loader() {
  return (
    <div style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', background:C.bg, minHeight:200 }}>
      <div style={{ textAlign:'center' }}>
        <div style={{ width:36, height:36, borderRadius:'50%', border:`3px solid ${C.layer3}`, borderTopColor:C.gold, animation:'shellSpin .8s linear infinite', margin:'0 auto 12px' }} />
        <div style={{ color:C.gold, fontSize:11 }}>جاري التحميل...</div>
      </div>
