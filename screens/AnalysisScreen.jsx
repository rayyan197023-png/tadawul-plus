                      ...
                      <div style={{display:"flex",alignItems:"center",gap:12,position:"relative"}}>
                        ...
                        <div style={{position:"relative",flexShrink:0}}>
                          ...
                          {(function(){
                            ...
                            return(<div style={{position:"absolute",bottom:-16,left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:2,background:trend?"rgba(16,201,126,.15)":"rgba(240,79,90,.15)",border:"1px solid "+(trend?"rgba(16,201,126,.3)":"rgba(240,79,90,.3)"),borderRadius:5,padding:"1px 5px",whiteSpace:"nowrap"}}>
