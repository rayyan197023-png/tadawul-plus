...
const FUNDS = [
  ...
  {name:"صندوق الأسهم السعودية -- أملاك", mgr:"أملاك كابيتال",     nav:18.70, ret1y:22.1, ret3y:51.3, ret5y:104.0, sharpe:1.38,beta:0.95, risk:"متوسط",  stars:4, minInv:1000,  type:"أسهم",   fee:1.5, bench:"تاسي +16.0%",   maxDD:-16.1},
  {name:"صندوق الأسهم السعودية -- الأهلي",mgr:"الأهلي كابيتال",    nav:21.30, ret1y:16.8, ret3y:38.4, ret5y:79.2,  sharpe:1.21,beta:0.91, risk:"متوسط",  stars:3, minInv:5000,  type:"أسهم",   fee:1.2, bench:"تاسي +10.7%",   maxDD:-13.8},
  {name:"صندوق المؤشر -- تاسي 30",        mgr:"سامبا كابيتال",     nav:9.85,  ret1y:14.2, ret3y:33.6, ret5y:68.5,  sharpe:1.10,beta:1.00, risk:"متوسط",  stars:3, minInv:500,   type:"مؤشر",   fee:0.5, bench:"تاسي 100%",      maxDD:-17.2},
  // ── متوازنة ──────────────────────────────────────────────────
  ...
  {name:"صندوق الدخل والنمو",             mgr:"الإنماء كابيتال",   nav:11.40, ret1y:13.5, ret3y:31.2, ret5y:59.8,  sharpe:1.25,beta:0.70, risk:"منخفض", stars:4, minInv:1000,  type:"متوازن", fee:1.3, bench:"60/40 +11.2%",   maxDD:-9.4},
  // ── قطاعية ───────────────────────────────────────────────────
  ...
  {name:"صندوق الطاقة والبتروكيماويات",   mgr:"الراجحي المالية",   nav:16.80, ret1y:8.4,  ret3y:19.2, ret5y:41.3,  sharpe:0.88,beta:1.05, risk:"مرتفع",  stars:3, minInv:2000,  type:"قطاعي",  fee:1.8, bench:"قطاع الطاقة",    maxDD:-24.1},
  {name:"صندوق البنوك السعودية",          mgr:"الأهلي كابيتال",    nav:13.50, ret1y:19.6, ret3y:44.8, ret5y:91.2,  sharpe:1.35,beta:0.98, risk:"متوسط",  stars:4, minInv:1000,  type:"قطاعي",  fee:1.6, bench:"قطاع البنوك",    maxDD:-15.6},
  {name:"صندوق الرعاية الصحية",           mgr:"البلاد المالية",    nav:8.20,  ret1y:14.8, ret3y:32.1, ret5y:67.4,  sharpe:1.18,beta:0.82, risk:"متوسط",  stars:4, minInv:1000,  type:"قطاعي",  fee:1.7, bench:"قطاع الصحة",     maxDD:-12.3},
  // ── عقاري ────────────────────────────────────────────────────
  {name:"صندوق العقارات المدرة",          mgr:"الأهلي كابيتال",    nav:10.18, ret1y:-3.2, ret3y:8.1,  ret5y:22.3,  sharpe:0.61,beta:0.90, risk:"متوسط",  stars:2, minInv:10000, type:"عقاري",  fee:1.8, bench:"ريتس -1.1%",    maxDD:-18.7},
  {name:"صندوق ريتس السعودية",            mgr:"سامبا كابيتال",     nav:7.60,  ret1y:2.4,  ret3y:12.8, ret5y:28.6,  sharpe:0.74,beta:0.85, risk:"متوسط",  stars:3, minInv:5000,  type:"عقاري",  fee:1.5, bench:"مؤشر ريتس",      maxDD:-16.2},
  // ── إسلامية ──────────────────────────────────────────────────
  {name:"صندوق الشريعة المتوافق",         mgr:"الإنماء كابيتال",   nav:15.60, ret1y:9.8,  ret3y:24.5, ret5y:48.7,  sharpe:1.05,beta:0.90, risk:"منخفض", stars:3, minInv:500,   type:"إسلامي", fee:1.0, bench:"تاسي +12.1%",   maxDD:-10.3},
  {name:"صندوق الراجحي الإسلامي",        mgr:"الراجحي المالية",   nav:22.10, ret1y:17.2, ret3y:39.8, ret5y:82.4,  sharpe:1.32,beta:0.87, risk:"منخفض", stars:4, minInv:500,   type:"إسلامي", fee:1.2, bench:"تاسي +11.1%",   maxDD:-11.8},
  {name:"صندوق الأسهم الإسلامية -- أملاك",mgr:"أملاك كابيتال",     nav:10.90, ret1y:15.6, ret3y:36.2, ret5y:74.8,  sharpe:1.18,beta:0.92, risk:"متوسط",  stars:4, minInv:1000,  type:"إسلامي", fee:1.3, bench:"تاسي +9.5%",    maxDD:-13.4},
  // ── دولية ────────────────────────────────────────────────────
  {name:"صندوق الأسهم الدولية",          mgr:"سامبا كابيتال",     nav:31.40, ret1y:24.8, ret3y:58.3, ret5y:121.0, sharpe:1.48,beta:0.88, risk:"مرتفع",  stars:5, minInv:5000,  type:"دولي",   fee:1.8, bench:"MSCI World",     maxDD:-19.8},
  {name:"صندوق الأسواق الناشئة",         mgr:"البلاد المالية",    nav:14.20, ret1y:12.3, ret3y:28.9, ret5y:58.4,  sharpe:1.02,beta:1.10, risk:"مرتفع",  stars:3, minInv:2000,  type:"دولي",   fee:2.0, bench:"MSCI EM",        maxDD:-23.5},
  // ── دخل ثابت ─────────────────────────────────────────────────
  {name:"صندوق الصكوك السعودية",         mgr:"الإنماء كابيتال",   nav:10.05, ret1y:5.2,  ret3y:14.8, ret5y:28.1,  sharpe:1.82,beta:0.18, risk:"منخفض", stars:4, minInv:1000,  type:"صكوك",   fee:0.8, bench:"مؤشر الصكوك",    maxDD:-3.8},
  {name:"صندوق السوق النقدي",            mgr:"الراجحي المالية",   nav:10.00, ret1y:5.8,  ret3y:16.2, ret5y:30.4,  sharpe:2.10,beta:0.05, risk:"منخفض", stars:5, minInv:1000,  type:"نقدي",   fee:0.5, bench:"SAIBOR +0.5%",   maxDD:-0.8},
];
