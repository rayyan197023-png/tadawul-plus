...
function AlertsPanel(props) {
  ...
  var sSet=useState(function(){return loadAlertSettings();}); var settings=sSet[0]; var setSettings=sSet[1];
            ...
            <div style={{display:"flex",flexDirection:"column",gap:14}}>
              ...
              <div style={{background:"linear-gradient(135deg,"+C.layer2+","+C.layer3+")",borderRadius:14,padding:16,border:"1px solid "+C.line}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:14}}>
                  ...
                  <div style={{fontSize:14,fontWeight:900,color:C.snow,fontFamily:"Cairo,sans-serif"}}>
                    الصوت
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{fontSize:12,color:C.mist,fontWeight:700,fontFamily:"Cairo,sans-serif"}}>
                    تفعيل الصوت
                  </div>
                  <button
                    onClick={function(){updateSettings({soundEnabled:!settings.soundEnabled});}}
                    style={{
                      width:48,
                      height:26,
                      borderRadius:13,
                      background:settings.soundEnabled?C.mint:C.line,
                      border:"none",
                      cursor:"pointer",
                      position:"relative",
                      transition:"all 0.3s",
                  ...
                  >
                    <div style={{
                      position:"absolute",
                      top:3,
                      right:settings.soundEnabled?3:25,
                      width:20,
                      height:20,
                      borderRadius:10,
                      background:C.snow,
                ...
                {settings.soundEnabled && (
                  <>
                    <div style={{fontSize:10,color:C.smoke,marginBottom:8,fontWeight:700,textAlign:"right"}}>
                      متى يُشغّل الصوت؟
                    </div>
                    {[
                      ...
                      var isActive = settings.soundMode === opt.k;
                      return (
                        <button
                          key={opt.k}
                          onClick={function(){updateSettings({soundMode:opt.k});}}
                          style={{
                            width:"100%",
                            padding:"12px",
                            background:isActive?C.electric+"18":C.layer2,
                            border:"1px solid "+(isActive?C.electric+"55":C.line+"44"),
                            borderRadius:10,
                            cursor:"pointer",
                            marginBottom:8,
                            textAlign:"right",
                        ...
                        >
                          <div style={{
                            fontSize:12,
                            fontWeight:800,
                            color:isActive?C.electric:C.mist,
                            fontFamily:"Cairo,sans-serif",
                            marginBottom:3,
                          }}>
                            {isActive && "● "}{opt.l}
              ...
              {/* 🎵 اختيار النغمة */}
              {settings.soundEnabled && settings.soundMode !== 'off' && (
                <div style={{background:"linear-gradient(135deg,"+C.layer2+","+C.layer3+")",borderRadius:14,padding:16,border:"1px solid "+C.line}}>
                  <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:14}}>
                    <span style={{fontSize:20}}>🎵</span>
                    <div style={{fontSize:14,fontWeight:900,color:C.snow,fontFamily:"Cairo,sans-serif"}}>
                  ...
                  {Object.values(SOUND_PRESETS).map(function(preset){
                    var isActive = settings.soundPreset === preset.id;
                    return (
                      <div
                        key={preset.id}
                        style={{
                          ...
                          gap:10,
                          padding:"12px",
                          background:isActive?C.gold+"12":C.layer2,
                          border:"1px solid "+(isActive?C.gold+"55":C.line+"44"),
                          borderRadius:10,
                          marginBottom:8,
                          cursor:"pointer",
                        }}
                        onClick={function(){updateSettings({soundPreset:preset.id});}}
                      >
                        <div style={{
                          width:20,
                          height:20,
                          borderRadius:10,
                          border:"2px solid "+(isActive?C.gold:C.line),
                        ...
                        <button
                          onClick={function(e){
                            e.stopPropagation();
                            playAlertSound(preset.id, settings.volume);
                          }}
                          style={{
                            width:36,
                            height:36,
              ...
              <div style={{background:"linear-gradient(135deg,"+C.layer2+","+C.layer3+")",borderRadius:14,padding:16,border:"1px solid "+C.line}}>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{fontSize:12,color:C.mist,fontWeight:700,fontFamily:"Cairo,sans-serif",marginBottom:3}}>
                      Browser Notifications
                    </div>
                    <div style={{fontSize:9,color:C.smoke,fontFamily:"Cairo,sans-serif"}}>
                      تنبيه حتى لو التطبيق مغلق
                    </div>
                  </div>
                  <button
                    onClick={function(){updateSettings({browserNotifications:!settings.browserNotifications});}}
                    style={{
                      width:48,
                      height:26,
                      borderRadius:13,
                      background:settings.browserNotifications?C.mint:C.line,
                      border:"none",
                      cursor:"pointer",
                      position:"relative",
                      transition:"all 0.3s",
                  ...
                  >
                    <div style={{
                      position:"absolute",
                      top:3,
                      right:settings.browserNotifications?3:25,
                      width:20,
                      height:20,
                      borderRadius:10,
                      background:C.snow,
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{fontSize:9,color:C.smoke,fontFamily:"Cairo,sans-serif"}}>
                      اهتزاز على الموبايل مع الصوت
                    </div>
                  </div>
                  <button
                    onClick={function(){updateSettings({vibration:!settings.vibration});}}
                    style={{
                      width:48,
                      height:26,
                      borderRadius:13,
                      background:settings.vibration?C.mint:C.line,
                      border:"none",
                      cursor:"pointer",
                      position:"relative",
                      transition:"all 0.3s",
              ...
              <div style={{
                padding:"12px 14px",
                background:C.plasma+"10",
                border:"1px solid "+C.plasma+"33",
                borderRadius:10,
                marginTop:4,
              }}>
                <div style={{fontSize:10,color:C.plasma,fontWeight:800,marginBottom:5}}>
                  ℹ️ ملاحظة
                </div>
                <div style={{fontSize:10,color:C.mist,lineHeight:1.6,fontFamily:"Cairo,sans-serif"}}>
                  هذه الإعدادات تُحفظ تلقائياً وتُطبّق على التنبيهات الذكية فقط.
