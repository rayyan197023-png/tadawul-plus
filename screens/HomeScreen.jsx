...
const STOCKS = [
  ...
  {sym:"1120", name:"الراجحي",        sec:"البنوك",          p:87.30,  pct:-1.37, v:4100000, avgVol:3200000, hi:95,  lo:68,  earn:null,            eps:null, prevEps:null},
  {sym:"1010", name:"الرياض",         sec:"البنوك",          p:24.56,  pct: 0.49, v:3200000, avgVol:2800000, hi:27,  lo:20,  earn:"20 أبريل 2026", eps:2.40, prevEps:2.19},
  {sym:"2350", name:"المراعي",        sec:"الغذاء",          p:14.22,  pct: 3.18, v:2800000, avgVol:1200000, hi:16,  lo:10,  earn:"14 أبريل 2026", eps:2.45, prevEps:2.39},
  {sym:"7010", name:"الاتصالات",      sec:"الاتصالات",      p:11.20,  pct: 1.76, v:4200000, avgVol:3500000, hi:13.5,lo:9,   earn:"29 أبريل 2026", eps:2.49, prevEps:2.34},
  {sym:"4001", name:"التصنيع",        sec:"الصناعة",        p:37.90,  pct: 1.20, v:210000,  avgVol:250000,  hi:38,  lo:28,  earn:null,            eps:null, prevEps:null},
  {sym:"6010", name:"القابضة",        sec:"البنوك",          p:32.40,  pct: 1.72, v:1500000, avgVol:1100000, hi:38,  lo:28,  earn:null,            eps:null, prevEps:null},
  {sym:"8010", name:"تكافل الراجحي",  sec:"التأمين",         p:22.10,  pct: 1.14, v:340000,  avgVol:280000,  hi:25,  lo:18,  earn:null,            eps:null, prevEps:null},
  {sym:"2082", name:"معادن",          sec:"التعدين",         p:52.80,  pct:-1.60, v:2100000, avgVol:1600000, hi:62,  lo:44,  earn:null,            eps:null, prevEps:null},
  {sym:"1211", name:"صحر",            sec:"التعدين",         p:19.45,  pct:-2.12, v:1200000, avgVol:900000,  hi:24,  lo:16,  earn:null,            eps:null, prevEps:null},
  {sym:"4280", name:"التجزئة",        sec:"التجزئة",         p:38.70,  pct: 1.90, v:560000,  avgVol:800000,  hi:46,  lo:33,  earn:null,            eps:null, prevEps:null},
];
...
export default function App() {
  ...
  return (
    <>
      ...
      `}</style>
      <div style={{maxWidth:420,margin:"0 auto",background:BG,minHeight:"100vh",
                   fontFamily:"'Cairo','Segoe UI',sans-serif",direction:"rtl",color:T1,fontSize:14}}>
        <TopBar idx={idx} chgP={chgP}/>
        <div style={{overflowY:"auto",height:"calc(100vh - 58px)"}}>
          <HomeContent idx={idx} chgP={chgP} market={market}/>
        </div>
      </div>
    </>
  );
...
function HomeContent({idx,chgP,market}){
...
function fgLabel(score) {
  ...
  if (score >= 45) return { ar:"محايد",        en:"Neutral",       col:"#f59e0b", bg:"rgba(245,158,11,.1)"  };
  if (score >= 25) return { ar:"خوف",          en:"Fear",          col:"#fb923c", bg:"rgba(251,146,60,.1)"  };
  return                  { ar:"خوف شديد",    en:"Extreme Fear",  col:"#ef4444", bg:"rgba(239,68,68,.12)"  };
}
...
function FearGreedIndex() {
  ...
  const ZONES = [
    ...
    { from: 40, to: 60,  col:"#f59e0b", label:"محايد"    },
    { from: 60, to: 80,  col:"#86efac", label:"طمع"      },
    { from: 80, to: 100, col:"#22c55e", label:"طمع شديد" },
  ];
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:12}}>
          ...
          <div style={{flexShrink:0}}>
            <svg width="200" height="108" viewBox="0 0 200 108">
              ...
              {/* Zone labels */}
              {[
                {x:14, y:90, t:"خوف شديد", c:"#ef4444"},
                {x:186,y:90, t:"طمع شديد", c:"#22c55e"},
              ].map((lb,i)=>(
