...
export const TOOLTIPS = {
  ...
  'Market Cap': {
    ...
    'عوامل الأداء المُثبتة': {
    title: 'عوامل الأداء المُثبتة',
    subtitle: 'Proven Factor Premia',
    description: 'ثلاثة عوامل أثبتت الدراسات العالمية قدرتها على تفسير عوائد الأسهم عبر عقود وأسواق متعددة.',
    details: [
      { label: 'الزخم ١٢ شهراً (٤٠٪)', value: 'عائد السنة بتخطّي الشهر الأخير -- Jegadeesh & Titman 1993' },
      { label: 'الجودة (٣٥٪)', value: 'العائد على الملكية والهامش والدَّين -- Novy-Marx 2013' },
      { label: 'تدنّي التقلّب (٢٥٪)', value: 'الأسهم الهادئة تتفوّق معدّلة بالمخاطر -- Frazzini & Pedersen 2014' },
    ],
    example: 'سهم صعد ٤٠٪ خلال سنة، بعائد على الملكية ١٨٪، وتذبذب ١٤٪ = درجة مرتفعة في العوامل الثلاثة.',
    category: 'fundamental',
  },

  'كفاءة السيولة': {
    title: 'كفاءة السيولة',
    subtitle: 'Amihud Illiquidity',
    description: 'يقيس مقدار تحرّك السعر مقابل كل مليون سهم متداول -- كلما قلّ الأثر، كانت السيولة أكفأ.',
    details: [
      { label: 'درجة عالية', value: '✅ السعر يتحرك بسلاسة -- دخول وخروج سهل' },
      { label: 'درجة منخفضة', value: '⚠️ صفقة صغيرة تحرّك السعر بشدة' },
      { label: 'المرجع', value: 'Amihud 2002 -- مقياس معياري عالمياً' },
    ],
    example: 'سهم يتحرك ٣٪ بحجم مليون سهم = سيولة ضعيفة؛ وآخر يتحرك ٠.٣٪ بنفس الحجم = سيولة ممتازة.',
    category: 'technical',
  },
};
