...
export const STOCKS = [
  ...
  { sym:"4080", sec:"الخدمات المالية", sectorId:"financial", rating:63 },
  ...
  { sym:"1201", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"1212", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:65 },
  { sym:"1214", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"1301", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:63 },
  { sym:"1302", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:65 },
  { sym:"1303", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:63 },
  { sym:"1304", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:63 },
  { sym:"1320", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"1321", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  ...
  { sym:"2200", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"2220", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"2240", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:65 },
  ...
  { sym:"4143", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"4148", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:62 },
  { sym:"4230", sec:"السلع الرأسمالية", sectorId:"capgoods", rating:63 },
  ...
  { sym:"2100", sec:"المواد الأساسية", sectorId:"materials", rating:62 },
  { sym:"2120", sec:"المواد الأساسية", sectorId:"materials", rating:63 },
  ...
  { sym:"2380", sec:"المواد الأساسية", sectorId:"materials", rating:62, oilCorr:0.70 },
  ...
  { sym:"2223", sec:"الطاقة", sectorId:"energy", rating:70, oilCorr:0.75 },
  ...
  { sym:"2080", sec:"الخدمات العامة", sectorId:"utilities", rating:67, oilCorr:0.70 },
  { sym:"2081", sec:"الخدمات العامة", sectorId:"utilities", rating:63 },
  { sym:"2082", sec:"الخدمات العامة", sectorId:"utilities", rating:80 },
  { sym:"2083", sec:"الخدمات العامة", sectorId:"utilities", rating:72 },
  { sym:"2084", sec:"الخدمات العامة", sectorId:"utilities", rating:65 },
  { sym:"5110", sec:"الخدمات العامة", sectorId:"utilities", rating:75 },

  // ── الخدمات التجارية والمهنية (Commercial & Professional Svc) ──
  { sym:"1213", sec:"الخدمات التجارية والمهنية", sectorId:"commercial", rating:62 },
  ...
  { sym:"2190", sec:"الخدمات التجارية والمهنية", sectorId:"commercial", rating:62 },
  { sym:"4270", sec:"الخدمات التجارية والمهنية", sectorId:"commercial", rating:63 },

  // ── النقل (Transportation) ──
  { sym:"4030", sec:"النقل", sectorId:"transport", rating:70 },
  { sym:"4031", sec:"النقل", sectorId:"transport", rating:68 },
  { sym:"4040", sec:"النقل", sectorId:"transport", rating:63 },
  { sym:"4110", sec:"النقل", sectorId:"transport", rating:63 },
  { sym:"4140", sec:"النقل", sectorId:"transport", rating:62 },
  ...
  // ── السلع الإستهلاكية طويلة الأجل (Consumer Durables) ──
  ...
  { sym:"6004", sec:"الخدمات الإستهلاكية", sectorId:"services", rating:68 },
  ...
  // ── الإعلام (Media) ──
  { sym:"4070", sec:"الإعلام", sectorId:"media", rating:62 },
  { sym:"4071", sec:"الإعلام", sectorId:"media", rating:63 },
  { sym:"4072", sec:"الإعلام", sectorId:"media", rating:68 },
  { sym:"4210", sec:"الإعلام", sectorId:"media", rating:65 },

  // ── التجزئة (Retailing) ──
  { sym:"4003", sec:"التجزئة", sectorId:"retail", rating:70 },
  { sym:"4008", sec:"التجزئة", sectorId:"retail", rating:68 },
  { sym:"4012", sec:"التجزئة", sectorId:"retail", rating:63 },
  { sym:"4050", sec:"التجزئة", sectorId:"retail", rating:65 },
  { sym:"4051", sec:"التجزئة", sectorId:"retail", rating:62 },
  { sym:"4180", sec:"التجزئة", sectorId:"retail", rating:63 },
  ...
  { sym:"4193", sec:"التجزئة", sectorId:"retail", rating:65 },
  { sym:"4194", sec:"التجزئة", sectorId:"retail", rating:63 },
  { sym:"4240", sec:"التجزئة", sectorId:"retail", rating:65 },
  { sym:"4160", sec:"التجزئة", sectorId:"retail", rating:63 },
  { sym:"4165", sec:"التجزئة", sectorId:"retail", rating:65 },

  // ── تجزئة الأغذية (Food & Staples Retailing) ──
  { sym:"4001", sec:"تجزئة الأغذية", sectorId:"foodretail", rating:75 },
  { sym:"4006", sec:"تجزئة الأغذية", sectorId:"foodretail", rating:70 },
  ...
  { sym:"4061", sec:"إنتاج الأغذية", sectorId:"food", rating:63 },
  { sym:"6001", sec:"إنتاج الأغذية", sectorId:"food", rating:65 },
  { sym:"6002", sec:"إنتاج الأغذية", sectorId:"food", rating:68 },
  { sym:"6010", sec:"إنتاج الأغذية", sectorId:"food", rating:65 },
  { sym:"6012", sec:"إنتاج الأغذية", sectorId:"food", rating:63 },
  ...
  { sym:"4280", sec:"إدارة وتطوير العقارات", sectorId:"realestate", rating:75 },
  ...
  { sym:"4145", sec:"التطبيقات وخدمات التقنية", sectorId:"tech", rating:65 },
  { sym:"4146", sec:"التطبيقات وخدمات التقنية", sectorId:"tech", rating:65 },
  { sym:"4147", sec:"التطبيقات وخدمات التقنية", sectorId:"tech", rating:65 },
  { sym:"4144", sec:"التطبيقات وخدمات التقنية", sectorId:"tech", rating:65 },
  ...
  { sym:"8270", sec:"التأمين", sectorId:"insurance", rating:63 },
...
export const SECTORS = [
  ...
  { id:'utilities',   name:'الخدمات العامة',               color:'#6ee7b7' },
  ...
  { id:'media',       name:'الإعلام',                      color:'#90a4c8' },
