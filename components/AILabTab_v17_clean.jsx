...
async function callAI(stock, type, onChunk, signal) {
...
export default function AILabTab() {
  ...
  const saveToLearning = async () => {
    ...
    try {
      ...
      const SKEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtkZ3FuY25tYWlmcm1vaGpvZW1jIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ4ODgxMTYsImV4cCI6MjA5MDQ2NDExNn0.RMWuQlFEFsFZe0EXGmmF4TlUtVcm5PWMlRYxT_Lmp0I";
  ...
  return (
    <div style={{ minHeight:"100vh", background:C.ink, direction:"rtl", fontFamily:"Cairo,'Segoe UI',sans-serif", color:C.snow }}>
      ...
      <div style={{ padding:"14px 14px 100px" }}>
        ...
        {/* ══ RUN BUTTON ══ */}
        {status === "idle" && (
          <button onClick={run} className="run-btn" style={{
