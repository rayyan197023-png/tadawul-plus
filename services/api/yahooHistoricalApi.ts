    ...
    validStocks.forEach(stk => {
      ...
      if (bar) {
        ...
        const enrichedStock = Object.assign({}, stk, {
          ...
          eps: dEPS,
          bv: dBV,
                   revenue: stk.revenue != null ? stk.revenue : null,
          revenueGrowth: (stk.revenueGrowth != null ? stk.revenueGrowth : (stk.rg != null ? stk.rg : null)),
          profitMargin: (stk.profitMargin != null ? stk.profitMargin : (stk.pm != null ? stk.pm : null)),
          netIncome: (stk.netIncome != null ? stk.netIncome : (stk.ni != null ? stk.ni : null)),
          currentRatio: (stk.currentRatio != null ? stk.currentRatio : (stk.cr != null ? stk.cr : null)),
          quickRatio: (stk.quickRatio != null ? stk.quickRatio : (stk.qr != null ? stk.qr : null)),
          debtToAssets: (stk.debtToAssets != null ? stk.debtToAssets : (stk.dta != null ? stk.dta : null)),
          interestCoverage: (stk.interestCoverage != null ? stk.interestCoverage : (stk.ic != null ? stk.ic : null)),
          assetTurnover: (stk.assetTurnover != null ? stk.assetTurnover : (stk.at != null ? stk.at : null)),
          forwardPE: (stk.forwardPE != null ? stk.forwardPE : (stk.fpe != null ? stk.fpe : null)),
          pegRatio: (stk.pegRatio != null ? stk.pegRatio : (stk.peg != null ? stk.peg : null)),
          growthEstimate: (stk.growthEstimate != null ? stk.growthEstimate : (stk.ge != null ? stk.ge : null)),
          fcf: stk.fcf != null ? stk.fcf : null,
          fcfYield: (stk.fcfYield != null ? stk.fcfYield : (stk.fcfy != null ? stk.fcfy : null)),
          beta: stk.beta != null ? stk.beta : null,
          shares: stk.shares != null ? stk.shares : null,
          ev: stk.ev != null ? stk.ev : null,
          oilCorr: stk.oilCorr != null ? stk.oilCorr : null,
          sector_beta: stk.sector_beta != null ? stk.sector_beta : null,
          hi: stk.hi != null ? stk.hi : bar.c,
          lo: stk.lo != null ? stk.lo : bar.c,
          w52h: stk.w52h != null ? stk.w52h : null,
          w52l: stk.w52l != null ? stk.w52l : null,
          rating: stk.rating != null ? stk.rating : null,
          epsGrw: stk.epsGrw != null ? stk.epsGrw : null,
          debt: stk.debt != null ? stk.debt : null,
        });
